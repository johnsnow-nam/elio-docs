...
# ⚡ 빠른 시작 — 30분 안에 첫 블록 실행

> 박스를 열고 **30분 안에** 첫 프로그램을 돌리는 것이 목표입니다. 처음이라도 혼자 할 수 있도록 만들었습니다.
...
- ELIO 보드 (박스 안에 있음)
- 스마트폰 (iOS 14+ 또는 Android 7+)
- USB 충전 케이블
- (선택) 레고 모터 · DC 모터 · 서보 모터 — 움직임 체험용
...
초음파 센서 또는 라인 센서를 연결하고 앱의 **센서 모니터** 화면에서 값이 변하는 걸 확인합니다.
